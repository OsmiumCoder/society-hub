...
const navItems: NavItem[] = [
    ...
    {
        title: 'Settings',
        href: route('universities.societies.edit', { university: props.university.id, society: props.society.id }),
        isActive: route().current('universities.societies.edit', { university: props.university.id, society: props.society.id }),
        can: props.can.update,
    },
];
